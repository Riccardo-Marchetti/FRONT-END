...
const Footer = () => {
  ...
  return (
    <>
      <Row className="d-flex flex-column ps-2 d-md-none footer-row ">
        <Col className="b-footer ps-2 pe-0">
          <Col
            className="d-flex justify-content-between align-items-center  py-3 footer-text-color ps-3 pe-0"
        ...
        <Col className="b-footer ps-2 pe-0">
          <Col
            className="d-flex justify-content-between align-items-center py-3 ps-3 pe-0 footer-text-color"
